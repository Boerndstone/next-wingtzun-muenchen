  ...
  return (
    <>
      <section className="container py-5">
        ...
        <ul className="fs-5">
          <li>
            <a href="#change" id="change-cookie-disclaimer">
              Datenschutz-Einstellungen ändern
            </a>
          </li>
          <li>
            <a href="#revoke" id="revoke-cookie-disclaimer">
        ...
        <p className="fs-5">
          Simeonidis Konstantinos <br />
          Corneliusstr. 24 <br />
          D-80469 München
          <br />
          Tel.: 0177 6460429 oder Tel.: 01577 2035061 <br />
        ...
        <h4 className="fs-4 text-uppercase">Serverdaten</h4>
        <p className="fs-5">
        ...
        <h4 className="fs-4 text-uppercase">Cookies</h4>
        <h5 className="fs-4 fw-light text-uppercase">
        ...
        <p className="fs-5">
          ...
          sich an dessen Hersteller bzw. Support. Bei sog. Flash-Cookies kann
          die Verarbeitung allerdings nicht über die Einstellungen des Browsers
          unterbunden werden. Stattdessen müssen Sie insoweit die Einstellung
          Ihres Flash-Players ändern. Auch die hierfür erforderlichen Schritte
          und Maßnahmen hängen von Ihrem konkret genutzten Flash-Player ab. Bei
        ...
        <h4 className="fs-4 text-uppercase">Google-Maps</h4>
        <p className="fs-5">
        ...
        <p className="fs-5">Überdies bietet Google unter</p>
        <CustomLinks
          href="https://adssettings.google.com/authenticated"
          name="https://adssettings.google.com/authenticated"
          target="_blank"
          icon={false}
          extraClass={["mb-3", "d-block"]}
        />
        <CustomLinks
          href="https://policies.google.com/privacy"
          name="https://policies.google.com/privacy"
          target="_blank"
          icon={false}
          extraClass={["mb-3", "d-block"]}
        />
        <p className="fs-5">weitergehende Informationen an.</p>
      </section>
    </>
  );
};
